...
import kotlinx.android.synthetic.main.activity_dinamis.*
import kotlinx.android.synthetic.main.activity_publikasi.*

class Dinamis : AppCompatActivity() {
    var webViewPrivacyPolicy: WebView?=null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dinamis)
        webView2()
    ...
    private fun webView2() {
        webViewPrivacyPolicy = findViewById(R.id.webViewdinamis) as WebView
        ...
        webViewPrivacyPolicy!!.loadUrl("https://salatigakota.bps.go.id/site/pilihdata.html")
        /* set webview client */
