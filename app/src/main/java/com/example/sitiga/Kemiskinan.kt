...
import kotlinx.android.synthetic.main.activity_kemiskinan.*
import kotlinx.android.synthetic.main.activity_publikasi.*

class Kemiskinan : AppCompatActivity() {
    ...
    private fun webView2() {
        webViewPrivacyPolicy = findViewById(R.id.webViewKemiskinan) as WebView
        ...
        webViewPrivacyPolicy!!.loadUrl("https://salatigakota.bps.go.id/subject/23/kemiskinan.html")
        /* set webview client */
