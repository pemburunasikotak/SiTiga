...
import kotlinx.android.synthetic.main.activity_kependudukan.*
import kotlinx.android.synthetic.main.activity_publikasi.*

class Kependudukan : AppCompatActivity() {
    ...
    private fun webView2() {
        ...
        webViewPrivacyPolicy!!.loadUrl("https://salatigakota.bps.go.id/subject/12/kependudukan.html")
        /* set webview client */
