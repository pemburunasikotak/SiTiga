...
import kotlinx.android.synthetic.main.activity_ketenagakerjaan.*
import kotlinx.android.synthetic.main.activity_publikasi.*

class Ketenagakerjaan : AppCompatActivity() {
    ...
    private fun webView2() {
        webViewPrivacyPolicy = findViewById(R.id.webViewKetenagakerjaan) as WebView
        ...
        webViewPrivacyPolicy!!.loadUrl("https://salatigakota.bps.go.id/subject/6/tenaga-kerja.html")
        /* set webview client */
