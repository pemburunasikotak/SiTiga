...
import kotlinx.android.synthetic.main.activity_lainya.*
import kotlinx.android.synthetic.main.activity_pdrd.*

class Pdrd : AppCompatActivity() {
    var webViewPrivacyPolicy: WebView?=null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pdrd)
        webView2()
    ...
    private fun webView2() {
        webViewPrivacyPolicy = findViewById(R.id.webViewpdrd) as WebView
