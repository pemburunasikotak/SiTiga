...
class Publikasi : AppCompatActivity() {
    ...
    private fun webView2() {
        webViewPrivacyPolicy = findViewById(R.id.webViewPublikasi) as WebView
        ...
        webViewPrivacyPolicy!!.loadUrl("https://salatigakota.bps.go.id/publication.html ")
        /* set webview client */
